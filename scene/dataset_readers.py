...
def readDataInfo(traindata, white_background):
    ...
    try:
        pcd = BasicPointCloud(points=traindata['pcd_points'].T, colors=traindata['pcd_colors'], normals=traindata['pcd_normals'], scene_flow=traindata['pcd_scene_flow'].T, motion_mask=traindata['pcd_motion_mask'])
    except:
        pcd = BasicPointCloud(points=traindata['pcd_points'].T, colors=traindata['pcd_colors'], normals=None ,scene_flow=traindata['pcd_scene_flow'].T, motion_mask=traindata['pcd_motion_mask'])
